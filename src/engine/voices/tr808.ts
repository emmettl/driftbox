import type { Voice, VoiceParams, VoiceSpec } from '../types'
import { accentGain, metallicSources, range, ratioRange } from './common'
...
export const TR808_VOICES: Voice[] = [
  ...
  { id: '808.ma', trim: 1.08, name: 'Maracas', machine: 'tr808', build: maracas },
]
