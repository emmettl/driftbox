...
| Ships with | Twenty-five catalog songs, including Small Hours (nocturnal jazz-electronica) and Orrery (five- and seven-beat melodic cycles). Ten rack++ arrangements include new chord and drone layers for Hothouse, Daydream Receiver, First Light and Small Hours. Driftlings remains available as an exported score. |
| Vibes mode | A player: now-playing, skip, filter pad, twenty-six scenes — no grid required |
...
| Visuals | Four meters, twenty-six scenes that react to music and touch, and a full-screen XY filter pad |
