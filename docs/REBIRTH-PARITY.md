...
| Stereo mix and stems export | Mastered song mix and pre-master stems | Same retained mix and per-voice stem review/export, plus summed Patch WAV and review/save/export for one stereo stem per terminal Out strip | Landed and render-equivalence tested for compatible songs; Out strips are the explicit rack-native bus model |
